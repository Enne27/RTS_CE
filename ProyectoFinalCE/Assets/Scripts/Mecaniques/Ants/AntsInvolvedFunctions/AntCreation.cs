...
public class AntCreation : MonoBehaviour
{
    ...
    /// <summary>
    /// Creaci�n de hormigas del jugador mediante el uso de recursos y actualizaci�n de la interfaz.
    /// </summary>
    /// <param name="antType">Tipo de hormiga a instanciar.</param>
    /// <param name="position">Transform de la posici�n donde instanciar.</param>
    ...
    /// A�ade al inventario del jugador o de la IA las hormigas creadas.
    /// </summary>
    /// <param name="quantity">Cantidad de hormigas a instanciar.</param>
    /// <param name="antType">Tipo de hormiga a instanciar.</param>
    /// <param name="position">Posici�n donde instanciar.</param>
    ...
    /// <summary>
    /// Instancia la hormiga en la posici�n indicada.
    /// </summary>
    ...
    /// <summary>
    /// Cambiamos el tipo de hormiga a instanciar por el par�metro.
    /// </summary>
